...
const ListecoursInstructeur = () => {
  ...
  return (
    ...
    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px', justifyContent: 'space-between', margin: '30px',marginTop:"80px" }}>
      ...
      {/* Pagination */}
      <MDBPagination className='mb-0' style={{ position: 'fixed', left: '50%', transform: 'translateX(-50%)', bottom: '120px', zIndex: '999', backgroundColor: '#f8f9fa', padding: '10px', borderRadius: '40px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)',border:"0.5px solid black" }}>
